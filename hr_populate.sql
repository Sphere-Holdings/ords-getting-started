...
rem   EMPLOYESS and hr.departments.  The dept_mgr_fk constraint is initially
...
REM *************************** insert data into the hr.regions table

Prompt ****** Populating hr.regions table ....
...
REM *************************** insert data into the hr.countries table

Prompt ****** Populating hr.countries table ....
...
REM *************************** insert data into the hr.locations table

Prompt ****** Populating hr.locations table ....
...
REM **************************** insert data into the hr.departments table

Prompt ****** Populating hr.departments table ....

REM disable integrity constraint to hr.employees to load data
...
REM *************************** insert data into the hr.jobs table

Prompt ****** Populating hr.jobs table ....
...
REM *************************** insert data into the hr.employees table

Prompt ****** Populating hr.employees table ....
...
REM ********* insert data into the hr.job_history table

Prompt ****** Populating hr.job_history table ....
...
REM enable integrity constraint to hr.departments
